...
import { MdClose, MdChevronRight, MdAdd } from 'react-icons/md';

const Dashboard = () => {
  
  const { user, subjects, attendanceCap, addNewSubject, darkMode } = useContext(AttendanceContext);
    ...
    <div className="page-container">
      ...
      <header style={{ 
        ...
        <div style={{ 
          ...
          borderRadius: '18px', color: 'white', display: 'flex', 
          alignItems: 'center', justifyContent: 'center', fontWeight: 'bold', 
          fontSize: '24px', boxShadow: '0 8px 20px rgba(79, 70, 229, 0.4)',
      ...
      {isAdding && (
        <div className="glass-card" style={{marginBottom: '20px', padding: '15px', display:'flex', gap:'10px', background: colors.cardBg, border: colors.border}}>
            <input 
                ...
                style={{flex:1, background: colors.inputBg, color: colors.text, border: 'none', borderRadius: '8px', padding: '10px'}}
            />
        ...
        {subjects.map(sub => {
          ...
          return (
            <div 
              ...
              style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '20px', background: colors.cardBg, border: colors.border }}
            >
              <div>
